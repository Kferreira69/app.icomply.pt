...
export const usersApi = {
  ...
  setOrgRole: (id: string, orgRoleId: string | null) => api.patch(`/users/${id}/org-role`, { orgRoleId }),
...
export const licensingApi = {
  ...
  listOrgUsers:    (orgId: string)                  => api.get(`/licensing/clients/${orgId}/users`),
  inviteOrgUser:   (orgId: string, data: any)       => api.post(`/licensing/clients/${orgId}/users`, data),
